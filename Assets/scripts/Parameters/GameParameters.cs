...
namespace PSParams{
	public static class GameParameters {
		...
		//安全地帯決定間隔
		public static readonly float safeZone_SetDulation=30.0f;
		//安全地帯決定後にアフェクトされるまでの猶予時間
		public static readonly float safeZone_Dulation=20.0f;
		...
		public static readonly float[] sw_damage=new float[7]{100.0f,500.0f,1.0f,100.0f,200.0f,100.0f,200.0f};
	...
	public static class SpawnItemRates {
		...
		//サブウェポン
		public static readonly int spawnNum_OnStartPerShip_Rate_Subweapon=120;

		//プレイヤの数１に対するスポーン数　ゲーム開始後の一定間隔　回復
		public static readonly int spawnNum_OnUpdatePerShip_Rate_Kaifuku=1;
		//サブウェポン
		public static readonly int spawnNum_OnUpdatePerShip_Rate_Subweapon=0;
