...
public class PickupAndWeaponManager : PS_SingletonBehaviour<PickupAndWeaponManager> {
	...
	public Transform SpawnSubweapon_Yudoudan(shipControl ship,Vector3 position,Quaternion qt,Transform parent){
		Transform trans=Spawn(subweaponYudoudan_Prefab,position,qt,parent);
	...
	public Transform SpawnSubweapon_Nuke(shipControl ship,Vector3 position,Quaternion qt,Transform parent){
		Transform trans=Spawn(subweaponNuke_Prefab,position,qt,parent);
		trans.gameObject.GetComponent<SubweaponShot>().Spawn(ship);
		return trans;
	...
	public Transform SpawnSubweapon_Napam(shipControl ship,Vector3 position,Quaternion qt,Transform parent){
		Transform trans=Spawn(subweaponNapam_Prefab,position,qt,parent);
		trans.gameObject.GetComponent<SubweaponShot>().Spawn(ship);
		return trans;
	...
	public Transform SpawnSubweapon_Zenhoukou(shipControl ship,Vector3 position,Quaternion qt,Transform parent){
		Transform trans=Spawn(subweaponZenhoukou_Prefab,position,qt,parent);
		trans.gameObject.GetComponent<SubweaponShot>().Spawn(ship);
		return trans;
